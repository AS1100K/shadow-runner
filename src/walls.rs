...
pub fn spawn_wall_collisions(
    ...
    wall_query: Query<
        (
            &GridCoords,
            // &Parent, // TODO: Fix Parent import in Bevy 0.16
    ...
    >,
    // parent_query: Query<&Parent, Without<GlobalWallEntity>>, // TODO: Fix Parent import
...
fn read_collisions(
    ...
    for collision_event in collision_events.read() {
        if let &CollisionEvent::Started(entity_one, entity_two, ..) = collision_event {
            ...
            let Ok(next_level_trigger_entity) = next_level_trigger_query.single() else {
                continue;
            };
